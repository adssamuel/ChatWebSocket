...
public class DataUtil {
	...
	public static java.util.Date getDateUtil(String dateStr, String formato) {
	...
	/**
	 * 
	 * @param  dateString "2024-07-17 09:16:29.100"
	...
	public static java.sql.Timestamp getTimestamp(String dateString) {
		...
		try {
			...
			// Definindo o formato do string
			SimpleDateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss.SSS");

			// Convertendo a string para java.util.Date
			java.util.Date parsedDate = dateFormat.parse(dateString);

			// Convertendo java.util.Date para java.sql.Timestamp
	 ...
	 */
	public static java.util.Date getDateUltilTimestamp(String dateString) {
	 ...
	 * @return              String no formato yyyy-MM-dd HH:mm:ss.SSS
	 */
	public static String getTimestamp(java.sql.Timestamp sqlTimestamp) {
		...
		// Convertendo java.sql.Timestamp para String
	 ...
	 * @return          String no formato yyyy-MM-dd HH:mm:ss.SSS
	 */
	public static String getTimestamp(java.util.Date utilDate) {
	...
	public static String getDataDiaFinalDoMes(int mes, int ano) {
		...
		return TextoUtil.completaAEsquerda("" + numDias, 2, "0") + "/" + TextoUtil.completaAEsquerda(mes + "", 2, "0") + "/" + ano;
	}
	...
	public static void validarDataCadastroBancoXLancamento(java.util.Date dataBanco, java.util.Date dataLancamento) {
		if (dataBanco == null || dataLancamento == null) {
			throw new RuntimeException("A data de lançamento ou data de cadastro do banco esta nula.");
		}

		int r = isDateCompare(dataLancamento, dataBanco);// DataLancamento menor que data banco
		if (r < 0) {
			throw new RuntimeException("A data de lançamento(" + getDate(dataLancamento) + ") e menor que a data de cadastro("
